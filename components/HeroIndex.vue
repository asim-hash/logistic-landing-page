  ...
  <section id="pulsar" class="hero is-dark is-fullheight has-text-centered" style="background-color: black">
    <div class="hero-body">
      <img class="c-hero-image"
           ...
           :srcset="require('@/assets/images/bg.jpg') + ' 1280w, ' + require('@/assets/images/bg.jpg') + ' 1920w'"
           alt="">
      ...
      <div class="container">
        <h1 class="title is-uppercase">
          Самая быстрая и качественная доставка товаров.
        </h1>
        <h2 class="subtitle">
          Экономим до 30% вашего времени - на поиске перевозчиков, брокеров и экспедиторов
          Посчитаем все расходы за 2 часа
        </h2>
        <p class="field">
